const problems = [
  {
    ...
    solution: "Automatizar pasos, documentos, avisos y flujos para reducir trabajo repetitivo y errores evitables.",
  },
  {
    label: "Datos desconectados",
    title: "La misma información copiada entre varias herramientas",
    solution: "Integrar aplicaciones y sincronizar datos mediante APIs para mantener una única información coherente.",
  },
  {
    label: "Poco control",
    title: "Procesos difíciles de seguir y decisiones sin contexto",
    solution: "Crear herramientas internas, paneles y bases de datos que hagan visible lo importante en cada momento.",
  },
  {
  ...
  },
  {
    ...
    solution: "Organizar el conocimiento y automatizar respuestas o clasificaciones manteniendo el control humano.",
  },
  {
    label: "IA sin rumbo",
    ...
    <section className="section problems-section" id="problemas">
      <div className="container">
        <div className="section-heading split-heading">
          ...
          <p>
            La digitalización empieza por detectar qué está frenando al equipo. A partir de ahí, construyo una solución
            concreta, fácil de usar y preparada para evolucionar.
          </p>
        </div>

        <div className="problem-grid">
          {problems.map((problem) => (
            <article className={`problem-card${"accent" in problem ? " accent-card" : ""}`} key={problem.label}>
